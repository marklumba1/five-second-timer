...
const App: React.FC = () => {
  ...
  const {time, seconds, handleStart, handlePause, handleReset} = useCountdown(initialTime)
return (
  ...
  This timer uses React hooks including <strong>useState</strong>, <strong>useEffect</strong>, <strong>useRef</strong>, <strong>useCallback</strong>, <strong>useContext</strong>, and a custom hook <strong>useCountdown</strong> for clean, reusable logic.
</p>
        <p className="text-6xl font-mono font-bold tracking-widest">{seconds}s {time}ms</p>
